...
import {StatusDrawer, WarningAndErrorDrawer, StatisticsDrawer, ControlFlowDrawer} from "../sidebar/drawer";
...
export default function EditorFooter() {
  ...
  return <Fragment>
    ...
    {statusFooter       && <div className="bottom-footer-drawer"><StatusDrawer /></div>}
    {warningErrorFooter && <div className="bottom-footer-drawer"><WarningAndErrorDrawer/></div>}
    {statisticsFooter   && <div className="bottom-footer-drawer"><StatisticsDrawer/></div>}
    {controlFlowFooter  && <div className="bottom-footer-drawer"><ControlFlowDrawer/></div>}
  </Fragment>;
}